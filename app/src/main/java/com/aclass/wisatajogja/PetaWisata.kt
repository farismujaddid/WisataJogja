...
class PetaWisata : Fragment(), OnMapReadyCallback,View.OnClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_peta_wisata, null)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        mp=childFragmentManager.findFragmentById(R.id.map_fragment) as SupportMapFragment
        mp.getMapAsync(this)
